...
const AllOrderTable: React.FC<Props> = ({ setSelectedOrder }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 300,
      render: (_: unknown, record: orderlist) => (
        <p className="overflow-hidden text-[13px] [display:-webkit-box] [-webkit-line-clamp:1] [-webkit-box-orient:vertical] font-normal">
          {record?.proName}
        </p>
      ),
    },
  ...
  return (
    <MyCard className="mt-6 text-white justify-between">
      <FlexBox
